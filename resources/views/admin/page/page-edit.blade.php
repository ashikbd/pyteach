  ...
  @section('content')
    ...
    <div class="panel panel-success">
		...
		@endif
                ...
                <form method="POST" action="{{ url('admin/pages/'.$page_detail['id']) }}" enctype="multipart/form-data" id="page_add_form1">
                  ...
                  <div class="panel-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="title" value="{{ old('title',$page_detail->title) }}">
                            </div>

                            <div class="form-group">
                              <label for="alias">Alias:</label>
                              <input type="text" class="form-control" name="alias" value="{{ old('alias',$page_detail->alias) }}">
                            </div>

                            <div class="form-group">
                              <label for="description">Page Detail:</label>
                              <textarea class="form-control richeditor" name="description" rows="10" cols="80">
                                {{ old('description',$page_detail->description) }}
                              </textarea>
                            </div>
                    ...
                    <div class="form-group">
                            ...
                            <select class="form-control" name="category" required>
                              ...
                              @foreach($category_list as $category)
                                <option value="{{ $category['id'] }}" @if($category['id'] == $page_detail['category']) selected @endif>{{ $category['category_name'] }}</option>
                              @endforeach
                            </select>
                          </div>
                  ...
                  <div id="uploaded_file">
                    @if(old('featured_image'))
                      ...
                      <br/><br/>
                    @elseif($page_detail['featured_image'])
                      <img src="{{ URL('uploads/pages/'.$page_detail['featured_image']) }}" style="height:200px;width:200px;">
                      <br/><br/>
