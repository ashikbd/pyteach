  ...
  @section('content')
    ...
    <div class="panel panel-success">
        <div class="panel-body">
          <a class="btn btn-success pull-right" href="{{url('admin/product-subcategories/create')}}">Create Sub-Category</a>
							...
							<td>
								<div class="dropdown">
										...
										<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
											<li>
												<a href="{{route('product-subcategories.edit', $category->id)}}">{{__('Edit')}}</a>
											</li>
											<li>
												<a href="{{route('product-subcategories.destroy', $category->id)}}" class="deleteConfirm">{{__('Delete')}}</a>
											</li>
